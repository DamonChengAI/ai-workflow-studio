...
const lines = [
  ...
  "## 产品结论",
  "",
  `这次 workflow 已把《${storyboard.theme}》拆成 ${storyboard.items.length} 个分镜，总时长 ${storyboard.total_duration_seconds} 秒，并产出研究记录、mock 图片、对应音频、失败 retry、真实 provider 视频、拼接视频和检查报告。`,
  "",
